...
avgf1act = abm_sim.Rule.Results{1}.avgf1act;
...
sdf1act = abm_sim.Rule.Results{1}.sdf1act;

sdpimcount = abm_sim.Rule.Results{1}.sdpimcount;
sdaimcount = abm_sim.Rule.Results{1}.sdaimcount;
avgm1count = abm_sim.Rule.Results{1}.avgm1count_tot;
sdm1countt = abm_sim.Rule.Results{1}.sdm1count;
avgm2count = abm_sim.Rule.Results{1}.avgm2count_tot;
sdm2countt = abm_sim.Rule.Results{1}.sdm2count;
avgintcount = abm_sim.Rule.Results{1}.avgintcount_tot;
...
avgf0count_tot = abm_sim.Rule.Results{1}.avgf0count_tot;
sdf0count = abm_sim.Rule.Results{1}.sdf0count;
avgf1count_tot = abm_sim.Rule.Results{1}.avgf1count_tot;
sdf1count = abm_sim.Rule.Results{1}.sdf1count;
avgrecruitedmac = abm_sim.Rule.Results{1}.recruitedmac;
avgrecruitedfibro =  abm_sim.Rule.Results{1}.recruitedfibro;
sdrecruitedmac = abm_sim.Rule.Results{1}.sdrecruitedmac;
sdrecruitedfibro = abm_sim.Rule.Results{1}.sdrecruitedfibro;
...
hold on;
h2=boundedline(tspan,avgm2act,sdm2act,'alpha','cmap',dark_blue,'linewidth',2);
hold on;
h3=boundedline(tspan,avgf1act,sdf1act,'alpha','cmap',dark_green,'linewidth',2); % light blue
...
subplot(2,2,2)
% hold on
h1=boundedline(tspan,avgm0count,sdm0countt,'alpha','cmap',light_red,'linewidth',2);
hold on;
h2=boundedline(tspan,avgm1count,sdm1countt,'alpha','cmap',light_blue,'linewidth',2);
hold on;
h3=boundedline(tspan,avgm2count,sdm2countt,'alpha','cmap',light_green,'linewidth',2);
hold on;
h4=boundedline(tspan,avgintcount,sdintcountt,'alpha','cmap',light_yellow,'linewidth',2);
hold on;
h5=boundedline(tspan,avgf0count_tot,sdf0count,'alpha','cmap',dark_red,'linewidth',2);
hold on;
...
subplot(2,2,3)
% hold on
h1=boundedline(tspan,avgpimcount,sdpimcount,'alpha','cmap',light_blue,'linewidth',2);% h2=plot(T_comp/3600,Y_comp(:,19)/max(Y_comp(:,19)),'linewidth',2,'color',dark_green);
hold on;
h2=boundedline(tspan,avgaimcount,sdaimcount,'alpha','cmap',light_yellow,'linewidth',2);% h2=plot(T_comp/3600,Y_comp(:,19)/max(Y_comp(:,19)),'linewidth',2,'color',dark_green);
...
subplot(2,2,4)
% hold on
h1=boundedline(tspan,avgrecruitedmac,sdrecruitedmac,'alpha','cmap',dark_blue,'linewidth',2); % light red
hold on
...
% subplot(5,2,10)
% % hold on
% h1=boundedline(tspan,avgrecruitedfibro,sdrecruitedfibro,'alpha','cmap',light_blue,'linewidth',2); % light blue
